...
cd A-typik
dotnet build app/Atypik.csproj
```
...
- Accessibility and i18n improvements (new languages welcome, see `app/src/i18n`).
- Documentation fixes.
...
3. Make sure the project builds with `dotnet build app/Atypik.csproj` and has zero warnings.
